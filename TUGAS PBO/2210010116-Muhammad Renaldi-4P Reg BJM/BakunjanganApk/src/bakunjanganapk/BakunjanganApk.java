...
//        koneksi crud = new koneksi();
//        crud.ubahdatakota(1, "Sungai Andai", "Banjarmasin", "70743", "Rumah Ibnu");
          
//        koneksi crud = new koneksi();
//        crud.hapusdatakota(1);

//        koneksi crud = new koneksi();
//        crud.simpandatawisata(1, "Air Terjun", "Jln.Sukamara", "Riam Kanan", "Full Service", "Keluarga", "Air Terjunnya cantik");

//        koneksi crud = new koneksi();
//        crud.ubahdatawisata(1, "Pantai Turki", "Jln.Gatot", "Pelaihari", "Pondok Full Ac", "Keluarga", "Pantainya sejuk dan bersih");
          
//        koneksi crud = new koneksi();
//        crud.hapusdatawisata(1);

//        koneksi crud = new koneksi();
//        crud.simpankomentar(1, "Rendi", "rendi7274@gmail.com", "waw", "2024-06-02", "istirahat.com");
          
//        koneksi crud = new koneksi();
//        crud.ubahkomentar(1, "Rin", "Rin7275@gmail.com", "uwu", "2024-06-03", "Ngoding.com");

//        koneksi crud = new koneksi();
//        crud.hapuskomentar(1);

//        koneksi crud = new koneksi();
//        crud.simpanberita(1, "2024-06-05", "Viral.png", "Wisata Terbaru 2024", "Anjay Air Terjunnya bagus");

//        koneksi crud = new koneksi();
//        crud.ubahberita(1, "2024-06-06", "Foto.png", "wisata bulan ini", "lokasinya sangat bersih");
